            ...
            <div className="flex flex-col h-full pt-16 gap-2">
              ...
              <div className="h-auto box-border py-2">
                <nav className="grid items-start px-4 text-base font-medium gap-2.5">
                  <button
                    className={`flex items-center gap-3 rounded-lg px-4 py-3 text-gray-800 transition-all hover:bg-gray-200 ${issue === "Food"
                  ...
                  <button
                    className={`flex items-center gap-3 rounded-lg px-4 py-3 text-gray-800 transition-all hover:bg-gray-200 ${issue === "Water"
                      ? "bg-gray-800 text-white hover:bg-gray-800"
                      : ""
                      }`}
                    value={"Water"}
                  ...
                  <button
                    className={`flex items-center gap-3 rounded-lg px-4 py-3 text-gray-800 transition-all hover:bg-gray-200 ${issue === "Electricity"
                      ? "bg-gray-800 text-white hover:bg-gray-800"
                      : ""
                      }`}
                    value={"Electricity"}
                  ...
                  <button
                    className={`flex items-center gap-3 rounded-lg px-4 py-3 text-gray-800 transition-all hover:bg-gray-200 ${issue === "Hostel_affairs"
                      ? "bg-gray-800 text-white hover:bg-gray-800"
                      : ""
                      }`}
                          ...
                          >
                            ...
                            <td className="px-4 pt-2.5 align-top box-border">
                              <div className="flex justify-center items-center">
                                <button
                                  className={`inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors rounded-md px-3 py-1 border-2 focus:outline-none ${complaint.photos.length > 0
                                ...
                                >
                                  <IoCameraOutline
                                    size={24}
                                    color={`${complaint.photos.length > 0
                                      ? "#00e600"
                                      : "#ff3333"
                                      }`}
                                  />
